...
path <- "/Users/judahaxelrod/Desktop/R/Baseball"
db <- dbConnect(MySQL(),dbname = "statcast", user ="root", password = "Verdict58!")
setwd(path)

source("Saved Functions/multi_spread.R")

era_fip <- read_csv("Raw data/ERA and FIP 2015-2019.csv") %>%
  select(Name, Season, ERA, FIP, xFIP)
```
